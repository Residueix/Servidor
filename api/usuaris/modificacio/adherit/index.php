                    ...
                    if($permis == 4){
                        if( ($email != null) && ($password != null) && ($nom != null) && ($cognom1 != null) && ($tipus != null) && ($telefon != null) && ($carrer != null) && ($cp != null) && ($poblacio != null) && ($horari != null) && ($nomEmpresa != null)){
                            if($tipus == 4){
                                ...
                                if($existeix){
                                    $db->modificarUsuariAdherit($id,$email, $password, $nom, $cognom1, $cognom2, $telefon, $tipus,$actiu,$carrer,$poblacio,$cp,$nomEmpresa,$horari);
